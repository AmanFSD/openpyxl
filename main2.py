...
from openpyxl import Workbook
from openpyxl.styles import Border, Side
from Functions2 import get_files, map_files_with_keys, extracting_files_names_from_excel, border_column, border_top_cell, find_incorrect_file_name, check_incorrect_item
...
for r, name in enumerate(incorrect_names, start=2):
    ...
    for cell in cells:
        ...
        if check_incorrect_item(incorrect_items, incorrect_items[i], cell.value, list_files_names, tup):
            cell.font = cell.font.copy(color='FF0000')
    i += 1
wb.save('/Users/aman/Data Science/openpyxl/Source Files/Document logs/Incorrect_Naming2.xlsx')
